...
class Woo_Vou_Pagination_Public{
		...
		var $className = "woo-vou-pagination";
		...
		function __construct( $ajaxpagination = 'woo_vou_ajax_pagination' ) {
			$this->nextT = esc_html__("Next",'woovoucher');
			$this->prevT = esc_html__("Previous",'woovoucher');
				...
				*/
				if($lastpage > 1){
						...
						if($this->page){
								...
								//anterior button
								if($this->page > 1)
										$this->pagination .= "<a class='page-numbers1' href=\"".esc_url($this->get_pagenum_link($prev))."\"  onclick = \"return $this->ajaxpagination('".$prev."')\" class=\"prev\">$p</a>";
									else
						...
						if($this->page){
								...
								if ($this->page < $counter - 1)
										$this->pagination .= "<a class='page-numbers1' href=\"".esc_url($this->get_pagenum_link($next))."\" onclick = \"return $this->ajaxpagination('".$next."')\" class=\"next\">$n</a>";
									else
