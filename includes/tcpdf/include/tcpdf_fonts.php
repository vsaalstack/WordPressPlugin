...
// ====================================================================================================================
	...
	public static function UTF8ArrayToUniArray($ta, $isunicode=true) {
		if ($isunicode) {
			return array_map(array('WPWEB_TCPDF_FONTS', 'unichrUnicode'), $ta);
		}
		return array_map(array('WPWEB_TCPDF_FONTS', 'unichrASCII'), $ta);
	}
	...
	public static function UTF8StringToArray($str, $isunicode, &$currentfont) {
		if ($isunicode) { 
			...
			$carr = array_map(array('WPWEB_TCPDF_FONTS', 'uniord'), (array) $chars);
		} else {
			$chars = str_split($str);
